...
const DistrictMaster = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        ...
        console.log('Updating district with ID:', editingDistrict.districtid);
        console.log('Update data:', formData);
        await axios.put(`http://localhost:3001/api/districts/${editingDistrict.districtid}`, formData);
  ...
  // Filter districts based on search term (guard against undefined fields)
