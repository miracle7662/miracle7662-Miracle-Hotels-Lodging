...
const Customers = React.lazy(() => import('../views/apps/Customers')) // Updated to use <Customers /> component
const Billing = React.lazy(() => import('./../views/apps/Billing')) // Updated to use <Billing /> component
const Country = React.lazy(() => import('./../views/apps/Country')) // Updated to use <Country /> component
...
const GuestTypemaster = React.lazy(() => import('../views/apps/GuestType'))
const Blockmaster = React.lazy(() => import('../views/apps/Blockmaster'))
const NationalityMaster = React.lazy(() => import('../views/apps/Nationality'))
const NewspaperMaster = React.lazy(() => import('../views/apps/Newspaper'))
const NoteMaster = React.lazy(() => import('../views/apps/Notemaster')) 
...
const FeatureMaster = React.lazy(() => import('../views/apps/Feature')) 
// const KitchenGroup = React.lazy(() => import('../views/apps/KitchenGroup'))


const HotelTypeMaster = React.lazy(() => import('../components/commonMaster/HotelTypeMaster'))
const MarketMaster = React.lazy(() => import('../components/commonMaster/MarketMaster'))
const BlockMaster = React.lazy(() => import('../components/commonMaster/BlockMaster'))
const FloorMaster = React.lazy(() => import('../components/commonMaster/FloorMaster'))
const ManageHotels = React.lazy(() => import('../components/userManagement/ManageHotels'))
...
// Superadmin Routes - Removed separate dashboard, using main dashboard instead
...
// },

    {
      ...
      children: [
        ...
        {
            path:'/masterpages/Blockmaster',
            name:'Blockmaster',
            element:<Blockmaster/>,
            route:PrivateRoute
        },
        {
         path:'/masterpages/GuestTypemaster',
         name:'GuestTypemaster',
         element:<GuestTypemaster/>,  
         route:PrivateRoute 
        },
                 {
          path:'/apps/guest-types',
          name:'GuestTypeMaster',
          element:<GuestTypemaster/>,  
          route:PrivateRoute 
         },
         {
          path:'/apps/nationalities',
          name:'NationalityMaster',
          element:<NationalityMaster/>,  
          route:PrivateRoute 
         },
         {
          path:'/apps/newspapers',
          name:'NewspaperMaster',
          element:<NewspaperMaster/>,  
          route:PrivateRoute 
         },
         {
          path:'/apps/features',
        ...
        {
          path:'/masterpages/NationalityMaster',
          name:'NationalityMaster', 
          element:<NationalityMaster/>,
          route:PrivateRoute,
        },
        {
          path:'/masterpages/FloorMaster',
          name:'FloorMaster',
          element:<FloorMaster/>,
          route:PrivateRoute,
        },
       {
        path:'/masterpages/Newspapermaster',
        name:'Newspapermaster',
        element:<NewspaperMaster/>,
        route:PrivateRoute,  
       },
       {
        path:'/masterpages/Notemaster',
        name:'Notemaster',
        element:<NoteMaster/>,
        route:PrivateRoute
       },
       {
        path:'/masterpages/RoomMaster',
        name:'RoomMaster',
        element:<RoomMaster/>,
        route:PrivateRoute,
       },
       {
        path:'/masterpages/RoomcategoryMaster',
        name:'RoomcategoryMaster',
        element:<RoomCategoryMaster/>,
        route:PrivateRoute,
       },

       {
        path:'/masterpages/FragmentMaster',
        name:'FragmentMaster',
        element:<FragmentMaster/>,
        route:PrivateRoute,
       },
      {
        path:'/masterpages/BookMaster',
        name:'BookMaster',
        element:<BookMaster/>,
        route:PrivateRoute,
      },
      //  {
      //   path:'/masterpages/ItemMaster',
      //   name:'ItemMaster',
      //   element:<ItemMaster/>,
      //   route:PrivateRoute,
      //  },
      {
        path:'/masterpages/FeatureMaster',
        name:'FeatureMaster',
        element:<FeatureMaster/>,
        route:PrivateRoute,
      },
      //  {
      //   path:'/masterpages/KitchenGroup',
      //   name:'KitchenGroup',
      //   element:<KitchenGroup/>,
      //   route:PrivateRoute,
      //  },
